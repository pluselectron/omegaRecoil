...
//cout<<" 111  "<<endl;
		//X = addallMomentun(nGamma,Gamma) + addallMomentun(nElectronp,Electronp) + addallMomentun(nElectronm,Electronm) + addallMomentun(nMuonp,Muonp) + addallMomentun(nMuonm,Muonm) + 
